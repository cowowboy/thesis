...
import performance.evaluation.MyResearch.Attribute;
...
//////////////////////////////////////////////////	
	...
	static int m_nItemSize = 353332 ;	// 137016  303332
...
//////////////////////////////////////////////////
	...
	static boolean hadBuildModel = false; //to let the building model process run one time
	...
	public static void main(String[] args) throws Exception {
		...
		*/
		...
		while(window<=L) {
			...
			// update the cache
			long startTime = System.currentTimeMillis(); //record runtime
			
			//if want to build model every time then delete this
			if(!hadBuildModel) {
				BuildModel();	// generate newData
				hadBuildModel = true;
			}
			...
			long endTime = System.currentTimeMillis();  //record runtime
			
			System.out.println(endTime-startTime);  //print runtime
...
//////////////////////////////////////////////////////////////    
	    // cluster result
	    target_cluster = new int[eval_2.getNumClusters()];
	    target_cluster_rank = new int[eval_2.getNumClusters()];
	    ...
	    for(int i=0; i<eval_2.getNumClusters(); i++) {
	    	for(int j=0; j<eval_2.getNumClusters(); j++) {
